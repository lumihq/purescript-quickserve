...
newtype StreamingResponse (contentType :: Symbol) r = StreamingResponse (Readable r)

instance isResponseStream :: IsSymbol contentType => IsResponse (StreamingResponse contentType s) where
